...
save(crime.new,file="./Fall2016-Proj2-grp6/data/crime.new.RData")
save(si,file="./Fall2016-Proj2-grp6/data/si.RData")
save(bronx,file="./Fall2016-Proj2-grp6/data/bronx.RData")
save(brooklyn,file="./Fall2016-Proj2-grp6/data/brooklyn.RData")
save(queens,file="./Fall2016-Proj2-grp6/data/queens.RData")
save(manhattan,file="./Fall2016-Proj2-grp6/data/manhattan.RData")
save(other,file="./Fall2016-Proj2-grp6/data/other.RData")
